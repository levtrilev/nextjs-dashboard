...
import LocationEditForm from "../[id]/edit/location-edit-form";
...
export default async function Page() {
  ...
  const userPermissions = await fetchDocUserPermissions(user.id as string, 'locations');
  ...
  return (
    <main>
      <Breadcrumbs
        breadcrumbs={[
          { label: 'Локации', href: '/repair/locations' },
          {
            label: 'Создать новую',
            href: '/repair/locations/create',
            active: true,
          },
        ]}
      />
