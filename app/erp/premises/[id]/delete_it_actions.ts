...
// import { Premise, PremiseForm, Region, RegionForm } from "@/app/lib/definitions";
...
//     cadastral_number = ${premise.name},
//     address = ${premise.name},
//     address_alt = ${premise.name},
//     type = ${premise.name},
//     status = ${premise.name},
//     status_until = ${premise.name},
//     region_id = ${premise.name},
//     owner_id = ${premise.name},
//     operator_id = ${premise.name},
...
//           le.name as owner_name,
//           le.name as operator_name,
//           s.name as section_name
//       FROM premises
//       LEFT JOIN sections s on p.section_id = s.id
//       LEFT JOIN regions r on p.region_id = r.id
//       LEFT JOIN legal_entities le on p.owner_id = le.id
//       LEFT JOIN legal_entities le on p.operator_id = le.id
//       WHERE p.id = ${id}
//     `;
