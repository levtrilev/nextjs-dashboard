...
export default function UsersRefTable(props: IUsersRefTableProps) {
    ...
    return (
        <div className="w-full">
            ...
            <RefSearch callback={handleSearch} term={props.term} elementIdPrefix="user" />
                            ...
                            <table className="table-fixed hidden w-full rounded-md text-gray-900 md:table">
                                <tbody className="divide-y divide-gray-200 text-gray-900">
                                    {props.users.map((user) => ((((
                                        user.name.toLowerCase().includes(props.term.toLowerCase())
                                        || props.term.length === 0) &&
