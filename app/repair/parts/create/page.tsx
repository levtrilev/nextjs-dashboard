...
import PartEditForm from "../[id]/edit/part-edit-form";
...
export default async function Page() {
  ...
  const userPermissions = await fetchDocUserPermissions(user.id as string, 'parts');
  ...
  return (
    <main>
      <Breadcrumbs
        breadcrumbs={[
          { label: 'Запчасти', href: '/repair/parts' },
          {
            label: 'Создать новую',
            href: '/repair/parts/create',
            active: true,
          },
        ]}
      />
