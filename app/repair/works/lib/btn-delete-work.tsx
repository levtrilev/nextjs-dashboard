// Delete Work button.tsx

'use client';
import { TrashIcon } from '@heroicons/react/24/outline';
import { useState, useRef } from 'react';
import MessageBoxSrv from '@/app/lib/message-box-srv';
import { deleteWork } from './works-actions';

export default function BtnDeleteWork({ id, name }: { id: string, name: string }) {
