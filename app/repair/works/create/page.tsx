...
import WorkEditForm from "../[id]/edit/work-edit-form";
...
export default async function Page() {
  ...
  const userPermissions = await fetchDocUserPermissions(user.id as string, 'works');
  ...
  return (
    <main>
      <Breadcrumbs
        breadcrumbs={[
          { label: 'Работы', href: '/repair/works' },
          {
            label: 'Создать новую',
            href: '/repair/works/create',
            active: true,
          },
        ]}
      />
