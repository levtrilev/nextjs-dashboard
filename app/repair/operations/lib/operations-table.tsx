...
import { fetchFilteredOperations } from './operations-actions';
import BtnDeleteOperation from './btn-delete-operation';
import { BtnEditOperationLink } from './operations-buttons';
            ...
            <div className="overflow-hidden rounded-md bg-gray-50 p-2 md:pt-0">
              ...
              <table className="table-fixed hidden w-full rounded-md text-gray-900 md:table">
                <thead className="rounded-md bg-gray-50 text-left text-sm font-normal">
                  <tr>
                    <th scope="col" className="w-4/12 px-4 py-5 font-medium sm:pl-6">Операция</th>
                    <th scope="col" className="w-4/12 px-4 py-5 font-medium sm:pl-6">Работа</th>
                  ...
                  {operations.map((operation) => (
                    <tr key={operation.id} className="group">
                      <td className="w-4/12 overflow-hidden whitespace-nowrap bg-white py-2 pl-6 pr-3 text-sm text-black">
                        <a
                          href={`/repair/operations/${operation.id}/edit`}
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-lg font-medium text-blue-800 underline">
                        <a href={`/repair/operations/${operation.id}/edit`}>
                          {operation.name}
                        </a>
                      </h3>
