...
import WorkordersRefTable from "./workorders-ref-table";

import dynamic from 'next/dynamic';
const Modal = dynamic(() => import('@/app/lib/common-modal'), { ssr: false });

interface IBtnWorkordersRefProps {
  workorders: Workorder[],
  handleSelectWorkorder: (new_workorder_id: string, new_workorder_name: string) => void,
}

export default function BtnWorkordersRef(props: IBtnWorkordersRefProps) {
    ...
    <div>
      ...
      <Modal open={modal} >
        <WorkordersRefTable
          ...
          handleSelectWorkorder={props.handleSelectWorkorder}
